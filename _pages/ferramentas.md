...
- [Github](https://github.com/): Desde que liberaram de modo gratuito a criação de repositórios privados, tenho usado o Github para armazenar pequenos projetos e anotações pessoais. Facilita em deixar mais agnóstica minha stack de anotações, dado que a base git me permite migrar entre serviços caso eu queira, além de funcionar em qualquer sistema operacional.
